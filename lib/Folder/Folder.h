...
public:
    ...
    */
    enum ePlayMode
    {
        ...
        LULLABYE,      // like ALBUM but stops playback after timeout TODO: RECORD VOICE OUTPUT.
        ALBUM,         // Play tracks in order on SD card (1,2,3...), endless, rollover.
        RANDOM,        // Like ALBUM but with shuffled non-repeating queue. TODO: RECORD VOICE OUTPUT
        SAVEPROGRESS,  // like ALBUM but saves track that is currently active. TODO: RE-RECORD VOICE OUTPUT
        ONELARGETRACK, // So-called Hörspielmodus. Queue like ALBUM but stops playback after finishing track. TODO: RE-RECORD VOICE OUTPUT.
